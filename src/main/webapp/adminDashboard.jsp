    ...
    <style>
        * {
        ...
        .welcome-header {
            ...
            margin-bottom: 30px;
            padding-bottom: 15px;
            border-bottom: 2px solid #ffc107; /* 黄色 */
        }
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu-section" onclick="toggleMenu(this)">
            ...
            <div class="menu-items">
                ...
                <a href="adminViewScores.jsp">查看所有成绩</a>
            </div>
        </div>
    ...
    <div class="main-content">
        <h1 class="welcome-header">管理员控制面板</h1>
        
        <div class="dashboard-card">
            <h3>系统概览</h3>
            <p>欢迎使用学生成绩管理系统管理员面板。请从左侧菜单中选择您要执行的操作。</p>
        </div>
        
        <div class="dashboard-card">
            <h3>快速操作</h3>
            <p>您可以快速添加学生成绩或查看用户列表。</p>
        </div>
    </div>
